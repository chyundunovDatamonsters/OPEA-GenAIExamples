...
export TRANSLATION_FRONTEND_SERVICE_IP=${TRANSLATION_EXTERNAL_HOST_IP}
export TRANSLATION_FRONTEND_SERVICE_PORT=18120
export TRANSLATION_BACKEND_SERVICE_NAME=translation
export TRANSLATION_BACKEND_SERVICE_IP=${TRANSLATION_EXTERNAL_HOST_IP}
